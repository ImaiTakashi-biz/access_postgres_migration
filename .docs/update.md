...
- `.docs/delivery_label_search_db/migrate_access_to_postgres.py` を現品票検索DB専用の処理に整理。
- `.docs/appearance_inspection_db/migrate_access_to_postgres.py` を外観検査記録DB専用の処理に整理。
